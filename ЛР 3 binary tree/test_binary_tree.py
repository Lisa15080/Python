...
class TestSumma(unittest.TestCase):
    def test_correct_variant(self):
        self.assertEqual(gen_bin_tree(6,2, l_leaf=lambda x:x*3, r_leaf = lambda y:y+4), {'2': [{'6': [{'18': [{'54': [{'162': [{'486': []}, {'166': []}]}, {'58': [{'174': []}, {'62': []}]}]}, {'22': [{'66': [{'198': []}, {'70': []}]}, {'26': [{'78': []}, {'30': []}]}]}]}, {'10': [{'30': [{'90': [{'270': []}, {'94': []}]}, {'34': [{'102': []}, {'38': []}]}]}, {'14': [{'42': [{'126': []}, {'46': []}]}, {'18': [{'54': []}, {'22': []}]}]}]}]}, {'6': [{'18': [{'54': [{'162': [{'486': []}, {'166': []}]}, {'58': [{'174': []}, {'62': []}]}]}, {'22': [{'66': [{'198': []}, {'70': []}]}, {'26': [{'78': []}, {'30': []}]}]}]}, {'10': [{'30': [{'90': [{'270': []}, {'94': []}]}, {'34': [{'102': []}, {'38': []}]}]}, {'14': [{'42': [{'126': []}, {'46': []}]}, {'18': [{'54': []}, {'22': []}]}]}]}]}]})
